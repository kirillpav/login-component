						...
						<form class="space-y-4 md:space-y-6" action="#">
							<div>
								...
								<input
									...
									name="email"
									id="email"
									class="bg-gray-50 border border-gray-300 text-slate-800 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:border-gray-600 dark:placeholder-gray-400  dark:focus:ring-blue-500 dark:focus:border-blue-500"
